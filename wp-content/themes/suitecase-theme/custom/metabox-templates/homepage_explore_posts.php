...
<div class="repeater-items">
    <?php if (!empty($this->settings['homepage_explore_posts']) && is_array($this->settings['homepage_explore_posts'])){
        foreach ($this->settings['homepage_explore_posts']['ids'] as $key => $id) {
            $post = get_post($id);
