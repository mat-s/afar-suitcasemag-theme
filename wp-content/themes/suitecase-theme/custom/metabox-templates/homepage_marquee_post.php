<div class="repeater-item autocomplete-container is-movable section-container">
    ...
    <input type="hidden" data-key="id" name="homepage_marquee_posts[ids][]" value="<?php echo $item['id'] ?? ''; ?>">
    <label>
        <input term-type="posts" class="posts-autocomplete autocomplete value-input" type="text" name="homepage_marquee_posts[titles][]" value="<?php echo $item['title'] ?? ''; ?>">
    </label>
