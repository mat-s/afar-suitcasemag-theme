...
if (!function_exists('ctl_sanitize_title')) {
    function ctl_sanitize_title($title)
    {
        ...
        $iso9_table = array(
            ...
            'Ю' => 'YU', 'Я' => 'YA', 'ЗГ' => 'ZGH', 'ЫЙ' => 'YIY', 'ИЙ' => 'YI', 'ІЙ' => 'IY', 'Ь' => '',
            'а' => 'a', 'б' => 'b', 'в' => 'v', 'г' => 'h',
            'ґ' => 'g', 'д' => 'd', 'е' => 'e', 'є' => 'ie',
            ...
            'с' => 's', 'т' => 't', 'у' => 'u', 'ф' => 'f',
            'х' => 'kh', 'ц' => 'ts', 'ч' => 'ch', 'ш' => 'sh',
            'щ' => 'shch', 'ю' => 'iu', 'я' => 'ia', 'зг' => 'zgh', 'ый' => 'yiy', 'ий' => 'yi', 'ій' => 'iy', 'ь' => '', 'ы' => 'y', 'Ы' => 'Y', 'э' => 'e', 'Э' => 'E', 'ё' => 'e', 'Ё' => 'E', 'ъ' => '', 'Ъ' => ''
        );
...
if (!has_filter('sanitize_title', 'ctl_sanitize_title')) add_filter('sanitize_title', 'ctl_sanitize_title', 9);
if (!has_filter('sanitize_file_name', 'ctl_sanitize_title')) add_filter('sanitize_file_name', 'ctl_sanitize_title');
